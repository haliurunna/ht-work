...
public class BPTestReportBusiness {
...
//        driver = new FirefoxDriver();
    ...
    @Test
    public void testReportBusiness()  throws Exception {
        ...
        reportOption.selectByVisibleText("Бизнес-отчет (шкал в профиле - 9)");
//        reportOption.selectByValue("3");
        TimeUnit.SECONDS.sleep(5);
        try {
