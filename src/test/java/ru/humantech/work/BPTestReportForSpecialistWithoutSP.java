...
public class BPTestReportForSpecialistWithoutSP {
...
//        driver = new FirefoxDriver();
    ...
    @Test
    public void testReportForSpecialistWithoutSP()  throws Exception {
        ...
        reportOption.selectByVisibleText("Проф-отчет : для специалиста (без сходных профилей... (шкал в профиле - 32)");
//        reportOption.selectByValue("6");
        TimeUnit.SECONDS.sleep(5);
        try {
...
//        return flag;
    ...
    private void reportCorrectness(WebDriverWait wait) {
        ...
        try {
            assertTrue(driver.findElement(By.xpath("//*[@class='HTReportBlock-content']//*[text()='Проф-отчет : для специалиста (без сходных профилей)']")).isDisplayed());
        } catch (AssertionError e) {
            System.err.println("Block 'Information about the test' must be for specialist without sp");
        }
        try {
